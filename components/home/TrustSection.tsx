        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {trustPoints.map((point, index) => {
            ...
            return (
              <Card
                key={point.id}
                className="bg-brand-card border-brand-border p-6 lg:p-8 flex flex-col items-center text-center group hover:border-brand-gold/50 transition-colors duration-300"
              >
