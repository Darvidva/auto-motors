...
export default function ContactPageClient({ businessInfo, heroImage }: { businessInfo: any; heroImage?: string }) {
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      <div className="relative h-[40vh] sm:h-[50vh] flex items-center justify-center">
        <Image
          src={heroImage || "/images/hero/contact.jpg"}
          alt="Contact Us"
          fill
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="bg-brand-surface border border-brand-border rounded-lg overflow-hidden">
                {businessInfo.hours?.map((day: any, index: number) => (
                  <div
                    key={day.day}
